...
;;;These functions are mostly date functions, including calendar conversions.
;;; Some basic functions not available in CLIPS are also found.
...
;These function might have been better implemented as a single function with an optional parameter for ?*iEDM*,
;   as follows: "(deffunction print-args (?a ?b $?c))".
